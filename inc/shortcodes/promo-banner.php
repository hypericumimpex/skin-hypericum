		...
		<div class="promo-banner-wrapper">
			<div id="<?php echo esc_attr( $id ); ?>" class="promo-banner<?php echo esc_attr( $class ); ?>" <?php if( $link && $attributes['url'] ) echo ( $onclick ); ?> >
				...
				<?php 
					echo '<style>';
						// Color
						if ( $custom_title_color && ! woodmart_is_css_encode( $custom_title_color ) ) echo '#' . $id . ' .banner-title{color:' . $custom_title_color . '}';
						if ( $custom_subtitle_color && ! woodmart_is_css_encode( $custom_subtitle_color ) ) echo '#' . $id . ' .banner-subtitle{color:' . $custom_subtitle_color . '}';
						if ( $custom_text_color && ! woodmart_is_css_encode( $custom_text_color ) ) echo '#' . $id . ' .banner-inner{color:' . $custom_text_color . '}';
