...
if( ! function_exists( 'woodmart_shortcode_brands' ) ) {
	function woodmart_shortcode_brands( $atts, $content = '' ) {
		...
		if( empty( $attribute ) || ! taxonomy_exists( $attribute ) ) return '<p class="not-brand-selected">' . esc_html__( 'You must select your brand attribute in Theme Settings -> Shop -> Brands', 'woodmart' ) . '</p>';
