...
class WOODMART_Import {
	...
	public function page_preview( $version = 'base' ) {
		?>
			<div class="page-preview">
				<img src="<?php echo WOODMART_DUMMY_URL; ?><?php echo esc_attr( $version ); ?>/preview.jpg" data-dir="<?php echo WOODMART_DUMMY_URL; ?>" alt="" />
			</div>
		<?php
	}
	...
	public function import_action() {
		...
		foreach ( $versions as $version ) {
			...
			$import = new WOODMART_Importversion( $this->_version, $this->_process, $this->_sliders );
			$import->run_import();
